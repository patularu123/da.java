...
public class Main {
    public static void main(String[] args) throws FileReadingException  {
        ...
        Autor camus = new Autor(myAuthors.get(0).get(0), myAuthors.get(1).get(0));
        Autor rowling = new Autor(myAuthors.get(0).get(1), myAuthors.get(1).get(1));
        Autor hesse = new Autor(myAuthors.get(0).get(2), myAuthors.get(1).get(2));
        Autor harari = new Autor(myAuthors.get(0).get(3), myAuthors.get(1).get(3));
        autori.add(camus);
        autori.add(rowling);
        autori.add(hesse);
        autori.add(harari);
        ...
        ArrayList<ArrayList<String> > myBiblioteci = new ArrayList<ArrayList<String> >();
        ArrayList<ArrayList<String> > myCititori = new ArrayList<ArrayList<String> >();

        myBooks = ReadFromCSVFileService.readFromBookFile("Book.csv");


        System.out.println(myBooks);
        System.out.println(myBiblioteci);
        System.out.println(myCititori);
        Carte book1 = new Carte(myBooks.get(0).get(0),myBooks.get(1).get(0),"Mihai", new Date(01 / 02 / 1001));
        Carte book2=new Carte(myBooks.get(0).get(1),myBooks.get(1).get(1),"Andrei",new Date(03 / 07 / 2001));
        Carte book3=new Carte(myBooks.get(0).get(2),myBooks.get(1).get(2),"Constantin",new Date(05 / 01 / 2021));
        carti.add(book1);
        carti.add(book2);
        carti.add(book3);
